                ...
                <div class="slider-container">
                    ...
                    <?php while( have_rows('case_results') ): the_row(); ?>  
                        ...
                        <div class="column-50">
                            ...
                            <p><a href="<?php echo $postURL; ?>">View Result</a></p>
                            <span class="spacer-30"></span>
                        </div>
                    <?php endwhile; ?>
                    <?php endif; ?> 
        ...
        <div class="columns">
            ...
            <div class="column-full block">                   
                <div class="slider-container">
                    ...
                    <img src="/wp-content/uploads/2023/02/oogle-review-logo-png-google-reviews-transparent-1156292055272f0fh5jor.png" alt="Google Review logo" class="review-logo">
                </div>
            </div>
            <?php if (get_field('add_cta_block')) { ?>
            <div class="column-full">
