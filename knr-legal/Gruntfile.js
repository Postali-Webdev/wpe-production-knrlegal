		...
		uglify: {
			min: {
				files: {
                    ...
                    'assets/js/practice-landing.min.js': ['assets/js/src/practice-landing.js'],
                    'assets/js/practice-parent.min.js': ['assets/js/src/practice-parent.js'],
                    'assets/js/results-scripts.min.js': ['assets/js/src/results-scripts.js'],
					'assets/js/blog-scripts.min.js': ['assets/js/src/blog-scripts.js'],
					'assets/js/custom-button.min.js': ['assets/js/src/custom-button.js']
				}
			}
		},
			...
			dist: {
				options: {
				  ...
				  files: { // Dictionary of files // 'destination': 'source'
					...
					'assets/css/admin-styles.css': 'assets/sass/admin-styles.scss'
				  }
			}
		},
